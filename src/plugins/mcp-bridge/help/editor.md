...
_55 tools in this family, generated from the @McpTool decorators — do not edit by hand._
...
| `web_editor_open` | write | `source` string **req**, `relPath` string, `ifDirty` string | Open the ASSET EDITOR with a document: source=empty (fresh Untitled asset) or source=library with relPath (e.g. "Custom/MyAsset.glb", relative to <workfolder>/library/). |
