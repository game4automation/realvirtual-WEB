...
/**
 * plugins/asset-editor/button-sim-store.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export type simulateButtonClick = any;
export const simulateButtonClick: any = () => undefined;
