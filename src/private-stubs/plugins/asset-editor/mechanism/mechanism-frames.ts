...
/**
 * plugins/asset-editor/mechanism/mechanism-frames.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const axisIsTranslation: any = () => undefined;
export const snapAxisToPrincipal: any = () => undefined;
export const worldDirectionToAxisField: any = () => undefined;
export const worldPointToAnchorField: any = () => undefined;
