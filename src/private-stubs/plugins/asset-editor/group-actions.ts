...
/**
 * plugins/asset-editor/group-actions.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const autoAssignToKinematic: any = () => undefined;
export const groupSelection: any = () => undefined;
