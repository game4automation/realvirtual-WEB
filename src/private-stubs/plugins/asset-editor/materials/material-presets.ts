...
/**
 * plugins/asset-editor/materials/material-presets.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const BUILTIN_MATERIAL_PRESETS: any = () => undefined;
export const loadCustomPresets: any = () => undefined;
