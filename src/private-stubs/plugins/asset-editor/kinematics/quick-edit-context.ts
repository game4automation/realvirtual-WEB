...
/**
 * plugins/asset-editor/kinematics/quick-edit-context.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const computeQuickEditContext: any = () => undefined;
