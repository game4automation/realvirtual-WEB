...
/**
 * plugins/asset-editor/editor-drive-gizmo-source.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const resolveEditorDriveGizmoSource: any = () => undefined;
