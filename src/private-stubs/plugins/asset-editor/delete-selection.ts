...
/**
 * plugins/asset-editor/delete-selection.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
export default {};
export const deleteSelectedNodes: any = () => undefined;
export const pruneDescendantPaths: any = () => undefined;
