...
/**
 * plugins/asset-editor/pending-open-store.ts — community stub for the COMMERCIAL asset editor (plan-434).
 *
...
//! Nothing can be handed to an editor that does not exist.
export function setPendingAssetOpen(_base: any): void { /* no editor to open into */ }
export function takePendingAssetOpen(): null { return null; }
